...
@app.route('/createaccmain.html')
def createaccmain():
    return render_template('/login/createaccmain.html')

@app.route('/signinmain.html')
def signinmain():
    return render_template('/login/signinmain.html')

@app.route('/user/usermain.html')
def usermain():
    return render_template('/user/usermain.html')

@app.route('/user/camerafeed.html')
def camerafeed():
    return render_template('/user/camerafeed.html')

@app.route('/videofeed')
def videofeed():
    return Response(road_sign_detection(), mimetype='multipart/x-mixed-replace; boundary=frame')
...
def road_sign_detection():
    cap = cv2.VideoCapture(0) # Or the appropriate index or path to your video source
...
def testcamera():
    ...
    pickle_in = open("server/model_trained.p", "rb")  ## rb = READ BYTE
